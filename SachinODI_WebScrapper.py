...
link = "https://stats.espncricinfo.com/ci/engine/stats/index.html?batting_hand=1;class=2;filter=advanced;orderby=start;player_involve=1934;size=200;template=results;type=batting;view=innings"
